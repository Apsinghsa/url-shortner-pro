      ...
      <section className="hero" style={{ textAlign: "left" }}>
        <div className="container">
          ...
          <p className="lead reveal" style={{ margin: "var(--space-4) 0 0" }}>
            Mikku is a URL shortener with built-in analytics and a Model Context Protocol server. The five screens below cover the public shortener, account flows, the authenticated dashboard, and the MCP integration guide.
          </p>
        </div>
      </section>
          ...
          <div className="stack-cards reveal-stagger">
            <Link to="/shorten" className="screen-card reveal">
              <div className="frame frame-tall">
                <MiniTopbar active={true} logo="$ mikku.site" nav="/shorten · /dashboard · /mcp" />
            ...
            <Link to="/login" className="screen-card reveal">
              <div className="frame frame-tall">
                <MiniTopbar active={true} logo="$ mikku.site" nav="/login" />
            ...
            <Link to="/register" className="screen-card reveal">
              <div className="frame frame-tall">
                <MiniTopbar active={true} logo="$ mikku.site" nav="/register" />
                <div className="mini-card">
                  <div className="eyebrow">// create_account</div>
                  <h2>join mikku.site</h2>
            ...
            <Link to="/dashboard" className="screen-card reveal">
              <div className="frame frame-tall">
                <MiniTopbar active={true} logo="$ mikku.site" nav="logout" />
            ...
            <Link to="/mcp" className="screen-card reveal">
              <div className="frame frame-tall">
                <MiniTopbar active={true} logo="$ mikku.site" nav="copy config" />
                <div className="mini-hero" style={{ padding: "10px 12px 4px" }}>
                  <div className="eyebrow">// mcp_integration</div>
                  <h2>for AI assistants</h2>
                </div>
                <div className="mini-code">
                  <span className="c-grey">$</span> <span className="c-green">"https://mikku.site/mcp"</span>
                  <br />
