...
export function HomeFlow() {
  return (
    <svg className="mini-flow" viewBox="0 0 400 200" preserveAspectRatio="xMidYMid meet" aria-hidden="true">
      ...
      <text x="30" y="155" fontFamily="IBM Plex Mono, monospace" fontSize="15" fill="#ffffff" fontWeight="600">mikku.site/aB12xY9z</text>
...
export function LoginFlow() {
  return (
    <svg className="mini-flow" viewBox="0 0 400 200" preserveAspectRatio="xMidYMid meet" aria-hidden="true">
      ...
      <text x="40" y="128" fontFamily="IBM Plex Mono, monospace" fontSize="8" fill="#111111">mikku_session=eyJhbGciOiJIUzI1…; HttpOnly; Secure</text>
...
export function McpFlow() {
  return (
    <svg className="mini-flow" viewBox="0 0 400 200" preserveAspectRatio="xMidYMid meet" aria-hidden="true">
      ...
      <text x="223" y="40" fontFamily="IBM Plex Mono, monospace" fontSize="7" fill="#999999" textAnchor="middle" letterSpacing="0.05em">mikku.site</text>
      ...
      <text x="52" y="156" fontFamily="IBM Plex Mono, monospace" fontSize="7.5" fill="#168a46">"mikku.site/aB12xY9z"</text>
