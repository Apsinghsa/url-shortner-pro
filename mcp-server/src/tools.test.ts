...
describe("handleShortenUrl", () => {
  ...
  it("calls the API with the token and formats the URL on success", async () => {
    ...
    mockShortenUrl.mockResolvedValue({
      ...
      data: {
        url: {
          ...
          shortUrl: "https://mikku.site/aB12",
          clickCount: 3,
    ...
    expect(mockShortenUrl).toHaveBeenCalledWith("https://example.com/long", "jwt");
    const text = (res.content[0] as { type: "text"; text: string }).text;
    expect(text).toContain("code: aB12");
    expect(text).toContain("short: https://mikku.site/aB12");
    ...
    mockGetMyLinks.mockResolvedValue({
      ...
      data: [
        ...
        },
        {
          ...
          urlCode: "xY34",
          longUrl: "https://b.com",
          shortUrl: "https://mikku.site/xY34",
          clickCount: 7,
